...
<template>
  ...
  >
    <div class="pb-4 md:pb-8 w-40">
      <img class="w-full" :src="getImage(props.orderItem.image_url)" alt="dress" />
    </div>
    <div
    ...
    >
      <div class="w-full flex flex-col justify-start items-start space-y-8">
        <RouterLink :to="`/product/${props.orderItem.id}`">
          <span class="text-xl text-yellow-500">Name</span>
      ...
      <div class="flex justify-between space-x-8 items-start w-full">
        <div class="w-full flex flex-col justify-start items-start space-y-8">
          <span class="text-xl text-yellow-500">Original</span>
        ...
        <div class="w-full flex flex-col justify-start items-start space-y-8">
          <span class="text-xl text-yellow-500">Quantity</span>
