  ...
  >
    ...
    >
      <div class="flex flex-col justify-start items-start flex-shrink-0">
        ...
        >
          <img
            src="https://scontent.fsgn5-12.fna.fbcdn.net/v/t39.30808-6/358559565_3632730096941596_2386023397235478891_n.jpg?_nc_cat=111&cb=99be929b-59f725be&ccb=1-7&_nc_sid=09cbfe&_nc_ohc=j2UoKE2eEg8AX87wMyx&_nc_ht=scontent.fsgn5-12.fna&oh=00_AfCxh1eBQlNcauHzRoccSqCA43QQ_wKZd5ndvrMfadZusA&oe=64CB57D6"
            alt="avatar"
            class="w-20"
          />
          <div class="flex justify-start items-start flex-col space-y-2">
            <p class="text-base font-semibold leading-4 text-left text-gray-800">Nguyen Tien Tai</p>
        ...
        >
          ...
          <img
            ...
            alt="email"
          />
          <p class="cursor-pointer text-sm leading-5">nguyentientai10@gmail.com</p>
        </div>
      </div>
