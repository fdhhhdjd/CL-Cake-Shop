<template>
  <header class="header-section-wrapper relative">
    <div
      class="w-full h-[90px] bg-white quomodo-shop-middle-bar lg:block hidden bg-[#ffbb38]"
    >
        ...
        <div class="relative h-full">
          <div class="flex justify-between items-center h-full">
            ...
            <div class="h-full flex justify-between items-center">
              <div
                class="category-and-nav flex xl:space-x-7 space-x-3 items-center"
              >
                <div class="nav">
            ...
            <div class="flex space-x-6 items-center">
              <div class="cart-wrapper group relative py-4">
                <div class="cart relative cursor-pointer">
                  <a rel="noopener noreferrer" href="https://profile-forme.cf">
                      ...
                      <ul>
                        <li class="w-full h-full flex">
                          ...
                          >
                            ...
                            <div
                              class="flex-1 h-full flex flex-col justify-center"
                            >
                              <p
                              ...
                              <p class="price">
                                <span
                                  class="offer-price text-qred font-600 text-[15px] ml-2"
                                  >$38</span
                                >
                              </p>
                            </div>
    ...
    <div class="quomodo-shop-drawer lg:hidden block w-full h-[60px] bg-white">
      <div class="w-full h-full flex justify-between items-center px-5">
        ...
        <div class="cart relative cursor-pointer">
          <a rel="noopener noreferrer" href="https://shopo-next.vercel.app/cart"
            ><span
              ><svg
                width="18"
                height="20"
